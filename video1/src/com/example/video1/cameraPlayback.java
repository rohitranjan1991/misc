...
public class cameraPlayback extends SurfaceView implements Callback,
	...
	public void onPreviewFrame(byte[] data, Camera camera) {
		...
		try {
			synchronized (mHolder) {
				...
				canvas.drawBitmap(rgbints, 0, width, canvasWidth
						- ((width + canvasWidth) >> 1), canvasHeight
						- ((height + canvasHeight) >> 1), width, height, false,
						null);
